      ...
      <section className="flex flex-col items-center justify-center p-6 bg-white md:flex-row md:space-x-4">
        ...
        <div className="w-full mt-4 md:mt-0 md:w-1/2">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Dengan pertumbuhan populasi yang pesat serta lahan yang terbatas,
            pertanian vertikal menjadi solusi menarik untuk memaksimalkan ruang.
          </p>
          <button 
            onClick={handleLearnMore} // Menambahkan event handler untuk tombol
            className="flex items-center px-4 py-2 mt-4 text-sm font-medium text-green-600 border border-green-600 rounded hover:bg-green-600 hover:text-white"
          >
            Learn More
          </button>
        </div>
